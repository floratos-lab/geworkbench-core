...
public class GenePixFileFormat extends DataSetFileFormat {
    ...
    public DSMicroarraySet getMArraySet(File file) throws org.geworkbench.components.parsers.InputFileFormatException {
        ...
        if (!checkFormat(file))
            throw new org.geworkbench.components.parsers.InputFileFormatException("GenepixFileFormat::getMArraySet - " + "Attempting to open a file that does not comply with the " + "Genepix format.");
        try {
