 ...
 * 
 */
public class DependencyManager2 {
	private Log log = LogFactory.getLog(DependencyManager2.class);

	private CCMTableModel2 ccmTableModel = null;
	 ...
	 * @param selectedRow
	 */
	DependencyManager2(final CCMTableModel2 ccmTableModel,
