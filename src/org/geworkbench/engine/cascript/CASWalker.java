            ...
            _t = _retTree;
            {
                ...
                do {
                    ...
                    if ((_t.getType() == IDENTIFIER)) {
                        ...
                        if (indices == null) System.out.println("We're not dealing with an array");
        ...
        try {      // for error handling
            ...
            switch (_t.getType()) {
                case NUM_INT: {
                    ...
                    match(_t, NUM_INT);
                    _t = _t.getNextSibling();
                    r = new CasInt(Integer.parseInt(tmp19_AST_in.getText()));
                    break;
                }
                case NUM_FLOAT: {
                    ...
                    match(_t, NUM_FLOAT);
                    _t = _t.getNextSibling();
                    r = new CasDouble(Double.parseDouble(tmp20_AST_in.getText()));
                    break;
                }
                case TRUE: {
                ...
                case IDENTIFIER: {
                    ...
                    if (arglist == null) r = ipt.getVariable(id);  //identifier, AKA a variable
                    else r = ipt.dimensionAccess(id, arglist);
                ...
                case IFSTR: {
                    ...
                    if (!(a instanceof CasBool)) return a.error("if: expression should be bool");
                    if (((CasBool) a).var) r = expr(thenif);
                    else if (null != elseif) r = expr(elseif);
                ...
                case WHILESTR: {
                    ...
                    a = expr(cond);
                    if (!(a instanceof CasBool)) return a.error("while: expression should be bool");
                ...
                case FORSTR: {
                    ...
                    _t = _t.getNextSibling();
                    a = expr(cond2);
                    if (!(a instanceof CasBool)) return a.error("for: expression should be bool");
                    while (!ipt.breakSet() && ((CasBool) a).getvar()) {
                        if (ipt.continueSet()) {
                            ipt.tryResetFlowControl();
                            continue;
                ...
                case OR: {
                    ...
                    if (a instanceof CasBool) r = (((CasBool) a).var ? a : expr(right_or));
                    else r = a.or(expr(right_or));
                ...
                case AND: {
                    ...
                    if (a instanceof CasBool) r = (((CasBool) a).var ? expr(right_and) : a);
                    else r = a.and(expr(right_and));
