...
public class GenePixParser {
     ...
     * listed in {@link org.geworkbench.engine.parsers.GenepixParseContext#columnNames
    ...
    public void parseLine(String line) {
        ...
        if (st.hasMoreTokens()) {
            token = st.nextToken().trim();
            int tokenIndex = 1;
            GenepixParseContext context = new org.geworkbench.engine.parsers.GenepixParseContext(columnsToUse);
