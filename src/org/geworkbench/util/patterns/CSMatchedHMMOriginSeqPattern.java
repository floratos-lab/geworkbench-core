 ...
 * @version 3.0
 */
public class CSMatchedHMMOriginSeqPattern extends org.geworkbench.util.patterns.CSMatchedSeqPattern {
    private int max;
    private HMMLoci[] loci;
    private List<HMMLoci> lociList;
//
//    public CSMatchedHMMOriginSeqPattern(DSSequenceSet _seqDB, String _consensusSequence, HMMLoci[] _loci) {
//        super(_seqDB);
