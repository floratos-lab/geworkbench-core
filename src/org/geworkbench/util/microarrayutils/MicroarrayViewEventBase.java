...
public abstract class MicroarrayViewEventBase implements VisualPlugin {
    ...
    public void receive( GeneSelectorEvent e, Object source ) {
        ...
        if ( e.getPanel() != null && e.getPanel().size() > 0 ) {
            ...
            // not enabled this.
            // The idea, however, is here ... we do not want to have checkboxes enabled if the user has not selected
            // anything from
            // the panels. On a larger scale, we may want to think these checkboxes altogether ... too many button
            // clicks for a
            // an end user!
            // if ( !chkActivateMarkers.isEnabled() ) chkActivateMarkers.setEnabled( true );
    ...
    protected void jbInit() throws Exception {
        ...
        // TODO see the "to do" listed in the receive method above ... if that is uncommented, make sure to uncomment
        // this
        // as well.
        // chkActivateMarkers.setEnabled( false );
