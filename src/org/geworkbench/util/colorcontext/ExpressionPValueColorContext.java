...
public class ExpressionPValueColorContext implements org.geworkbench.util.colorcontext.ColorContext, Serializable {
    ...
    public Color getMarkerValueColor(DSMarkerValue mv, DSGeneMarker mInfo, float intensity) {
        ...
        intensity *= 2;
        double value = mv.getValue();
        org.geworkbench.util.Range range = ((CSExpressionMarker) mInfo).getRange();
