...
public class ProgressBarT
	...
	/**
     * Defines a ProgressBarT that has bounds and values shown increment from a
    ...
    /**
     * Singleton representing a <code>ProgressBarT</code> with a specified range
     * This needs to set before using the instance
     */
    private static ProgressBarT boundedProgressBar = new ProgressBarT(
        BOUNDED_TYPE);
    ...
    /**
     * Singleton representing a <code>ProgressBarT</code> without a range
     * This needs to set before using the instance
     */
    private static ProgressBarT indeterminateProgressBar =
        new ProgressBarT(INDETERMINATE_TYPE);
    JLabel jLabel1 = new JLabel();
    GridLayout gridLayout1 = new GridLayout();
    /**
     * Factory method to create one of the two above defined ProgressBarT types
     * @param type type of the <code>ProgressBarT</code>
     * @return <code>ProgressBarT</code> instance
     */
    public static ProgressBarT create(int type) {
        if (type == BOUNDED_TYPE) {
            if (boundedProgressBar.isShowing()) {
                boundedProgressBar = new ProgressBarT(BOUNDED_TYPE);
            }
            ...
            if (indeterminateProgressBar.isShowing()) {
                indeterminateProgressBar = new ProgressBarT(INDETERMINATE_TYPE);
            }
...
//            jProgressBar.setStringPainted(false);
    ...
    /**
     * Updates the ProgressBarT by an amount specified in the <code>
    ...
    /**
     * Updates the ProgressBarT to an amount specified
     * @param value value that the <code>ProgressBarT</code> has to be set to
    ...
    /**
     * Starts animation and shows the <code>ProgressBarT</code>
     */
    public void start() {
    ...
    /**
     * Hides the <code>ProgressBarT</code>
     */
    public void dispose() {
        this.setTitle("");
        this.setMessage("");
    ...
    /**
     * Sets the title
     * @param title title of the <code>ProgressBarT</code>
     */
    ...
    /**
     * Sets the message
     * @param message to be shown on the <code>ProgressBarT</code>
     */
    ...
    /**
     * Bit to specify if the current value of the <code>ProgressBarT</code> has
     ...
     * @param t type of the <code>ProgressBarT</code>
     */
    private ProgressBarT(int t) {
        super();
        if (t == BOUNDED_TYPE) {
            type = t;
            jProgressBar.setIndeterminate(false);
     ...
     * <code>ProgressBarT</code> display
     */
