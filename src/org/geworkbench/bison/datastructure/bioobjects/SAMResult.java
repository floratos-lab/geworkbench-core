...
public class SAMResult extends CSAncillaryDataSet<DSMicroarray>{
...
*/	
	public SAMResult(final DSMicroarraySet maSet, String string, DSMicroarraySetView<DSGeneMarker, DSMicroarray> data,
			float deltaInc, float deltaMax,	float[] dd, float[] dbar,float[] pvalue,
			float[] fold, float[] fdr, float[][] matfdr){
		super(maSet, string);
		this.maSet=maSet;
		this.data=data;
