...
public class AnnotationParser {
    ...
    public static final String GENE_ONTOLOGY_BIOLOGICAL_PROCESS =
            "Gene Ontology Biological Process";
    public static final String GENE_ONTOLOGY_CELLULAR_COMPONENT =
            "Gene Ontology Cellular Component";
    public static final String GENE_ONTOLOGY_MOLECULAR_FUNCTION =
    ...
    private static Map<DSDataSet,
            String> datasetToChipTypes = new HashMap<DSDataSet, String>();
    private static Map<String, ListOrderedMap<String, Map<String,
            String>>>
            chipTypeToAnnotations = new HashMap<String, ListOrderedMap<String,
                                    Map<String, String>>>();
    ...
    public static Map<String, ListOrderedMap<String,
            Vector<String>>>
            geneNameMap = new HashMap<String, ListOrderedMap<String,
                          Vector<String>>>();
