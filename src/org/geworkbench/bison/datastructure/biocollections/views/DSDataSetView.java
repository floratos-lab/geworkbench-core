 ...
 * </p>
 * 
 * Provides a view in to a {@link DSDataSet} and its associated
 * {@link DSPanel DSPanels}. The view can be optionally limited to exposing
 * only those elements in active panels.
 * 
