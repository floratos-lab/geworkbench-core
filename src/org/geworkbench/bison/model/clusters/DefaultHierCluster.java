 ...
 * <p/>
 * Generalization of the <code>Cluster</code> contract that encapsulates
...
public class DefaultHierCluster extends AbstractCluster implements HierCluster {
    ...
    /**
     * Returns the Maximum Algorithmic Height of any <code>Cluster</code> in the
     * Hierarchical Cluster Tree that this <code>Cluster</code> is a part of
     *
     ...
     *
     * @param hc    child to be added
     * @param index index at which the child is to be added
     */
     ...
     *
     * @param index child with the index that has be retrievd
    ...
    /**
     * {@link java.lang.Comparable} method that compares this <code>Cluster</code>
     * to another Hierarchical CLuster node. The basis of comparison is the number
     * of children bothe the nodes contain
     *
     * @param o <code>HierCluster</code> to be compared to
     * @return <li> 1 if o contains more children </li>
     *         <li> -1 if this <code>HierCluster</li> contains more children </li>
