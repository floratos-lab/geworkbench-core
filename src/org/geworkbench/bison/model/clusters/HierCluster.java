 ...
 * <p/>
 * Defines a Generalization of a <code>Cluster</code> that would be obtained
 * from a Hierarchical Clustering Analysis
 *
...
public interface HierCluster extends Cluster, Comparable {
    ...
    /**
     * Returns the combinatorial depth of this node in the Hierachical cluster
     * tree i.e. the number of nodes including this node to be traversed to
     * get to a leaf node
     *
     * @return order
     */
    ...
    /**
     * Add the designated node hc in the current cluster, at the designated
     * index position.
     *
