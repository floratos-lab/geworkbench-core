...
public class MTOMSampleMTOMSampleSOAP11Port_httpStub extends
	...
	public org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentResponse attachment(
			...
			org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentRequest attachmentRequest6)
...

	{
		...
		try {
			...
			env = toEnvelope(getFactory(_operationClient.getOptions()
					.getSoapVersionURI()), attachmentRequest6,
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					public void onMessage(
						...
						try {
							...
							callback
									.receiveResultattachment((org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentResponse) object);
							...
							if (faultElt != null) {
								if (faultExceptionNameMap.containsKey(faultElt
									...
									try {
										...
										callback
												.receiveErrorattachment(new java.rmi.RemoteException(
														ex.getMessage(), ex));
									} catch (java.lang.ClassCastException e) {
	...
	// http://localhost:8080/axis2/services/MTOMSample
	public static class AttachmentResponse implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.apache.org/axis2/mtomsample/", "AttachmentResponse",
				"ns2");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
					...
					AttachmentResponse.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							...
							"type", namespacePrefix + ":AttachmentResponse",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "AttachmentResponse", xmlWriter);
				}
			}
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(
					...
					new java.lang.Object[] {
							...
							org.apache.axis2.databinding.utils.ConverterUtil
									.convertToString(localAttachmentResponse) },
					null);
						...
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName(
											"http://ws.apache.org/axis2/mtomsample/",
											"AttachmentResponse").equals(reader
											.getName())) {
								...
								object
										.setAttachmentResponse(org.apache.axis2.databinding.utils.ConverterUtil
	...
	public static class AttachmentRequest implements
			org.apache.axis2.databinding.ADBBean {

		public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
				"http://ws.apache.org/axis2/mtomsample/", "AttachmentRequest",
				"ns2");
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					AttachmentRequest.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName(
											"http://ws.apache.org/axis2/mtomsample/",
											"AttachmentRequest").equals(reader
											.getName())) {

								object
										.setAttachmentRequest(AttachmentType.Factory
												.parse(reader));
	...
	public static class AttachmentType implements
			org.apache.axis2.databinding.ADBBean {
		/*
		 * This type was generated from the piece of schema that had name =
		 * AttachmentType Namespace URI = http://ws.apache.org/axis2/mtomsample/
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					AttachmentType.this.serialize(parentQName, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":AttachmentType",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "AttachmentType", xmlWriter);
				}
			...
			if (localBinaryDataTracker) {
				...
				localBinaryData.serialize(
						new javax.xml.namespace.QName(
								"http://ws.apache.org/axis2/mtomsample/",
								"binaryData"), factory, xmlWriter);
			}
			xmlWriter.writeEndElement();
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			if (localFileNameTracker) {
				elementList.add(new javax.xml.namespace.QName(
						"http://ws.apache.org/axis2/mtomsample/", "fileName"));
			...
			public static AttachmentType parse(
				...
				try {
							...
							if (!"AttachmentType".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (AttachmentType) ExtensionMapper
					...
					if (reader.isStartElement()
						...
						object
								.setBinaryData(Base64Binary.Factory
										.parse(reader));
	...
	public static class ContentType_type0 implements
			org.apache.axis2.databinding.ADBBean {
		...
		public org.apache.axiom.om.OMElement getOMElement(
			...
			org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(
				...
				public void serialize(
						org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter)
						throws javax.xml.stream.XMLStreamException {
					ContentType_type0.this.serialize(MY_QNAME, factory,
							xmlWriter);
				}
			};
			return new org.apache.axiom.om.impl.llom.OMSourcedElementImpl(
		...
		public void serialize(
			...
			if (serializeType) {
				...
				if ((namespacePrefix != null)
					...
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", namespacePrefix + ":contentType_type0",
							xmlWriter);
				} else {
					writeAttribute("xsi",
							"http://www.w3.org/2001/XMLSchema-instance",
							"type", "contentType_type0", xmlWriter);
				}
			}
	...
	public static class Base64Binary implements
		...
		/*
		 * This type was generated from the piece of schema that had name =
		 * base64Binary Namespace URI = http://www.w3.org/2005/05/xmlmime
			...
			public static Base64Binary parse(
				...
				try {
						...
						if (fullTypeName != null) {
							...
							if (!"base64Binary".equals(type)) {
								...
								java.lang.String nsUri = reader
										.getNamespaceContext().getNamespaceURI(
												nsPrefix);
								return (Base64Binary) ExtensionMapper
										.getTypeObject(nsUri, type, reader);
							}
					...
					if (tempAttribContentType != null) {
						...
						object.setContentType(ContentType_type0.Factory
	...
	private org.apache.axiom.om.OMElement toOM(
		...
		try {
			return param
					.getOMElement(
							org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentResponse.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentRequest.class
					.equals(type)) {

				return org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentRequest.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentResponse.class
					.equals(type)) {

				return org.apache.ws.axis2.mtomsample.MTOMSampleMTOMSampleSOAP11Port_httpStub.AttachmentResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
