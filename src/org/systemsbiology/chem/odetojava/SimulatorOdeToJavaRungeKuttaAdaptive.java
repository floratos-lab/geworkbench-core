...
public class SimulatorOdeToJavaRungeKuttaAdaptive extends SimulatorOdeToJavaBase implements IAliasableClass, ISimulator {
    ...
    protected void runExternalSimulation(Span pSimulationTimeSpan, double[] pInitialDynamicSymbolValues, double pInitialStepSize, double pMaxAllowedRelativeError, double pMaxAllowedAbsoluteError, String pTempOutputFileName) {
        ...
        ErkTriple erkTriple = new ErkTriple(simulationModel, pSimulationTimeSpan, pInitialDynamicSymbolValues, pInitialStepSize, simulationButcherTableau, highOrderArgument, absoluteTolerance, relativeTolerance, pTempOutputFileName, "StiffDetect_Off", "EventLoc_Halt", "Stats_Off");
