...
public abstract class SimulatorOdeToJavaBase extends Simulator implements ODE, ODERecorder {
    ...
    protected abstract void runExternalSimulation(Span pSimulationTimeSpan, double[] pInitialDynamicSymbolValues, double pInitialStepSize, double pMaxAllowedRelativeError, double pMaxAllowedAbsoluteError, String pTempOutputFileName);

    public void simulate(double pStartTime, double pEndTime, SimulatorParameters pSimulatorParameters, int pNumResultsTimePoints, String[] pResultsSymbolNames, double[] pRetResultsTimeValues, Object[] pRetResultsSymbolValues) throws DataNotFoundException, IllegalStateException, IllegalArgumentException, SimulationAccuracyException, SimulationFailedException {
        conductPreSimulationCheck(pStartTime, pEndTime, pSimulatorParameters, pNumResultsTimePoints, pResultsSymbolNames, pRetResultsTimeValues, pRetResultsSymbolValues);
        ...
        Symbol[] requestedSymbols = createRequestedSymbolArray(mSymbolMap, pResultsSymbolNames);
        ...
        runExternalSimulation(simulationTimeSpan, mDynamicSymbolValues, initialStepSize, maxAllowedRelativeError, maxAllowedAbsoluteError, tempOutputFileName);
        ...
        try {
            readSimulationOutput(tempOutputFile, mSymbolEvaluator, mDynamicSymbolValues, pStartTime, pEndTime, pNumResultsTimePoints, requestedSymbols, pRetResultsTimeValues, pRetResultsSymbolValues);
    ...
    protected void readSimulationOutput(File pSimulationResultsFile, SymbolEvaluatorChemSimulation pSymbolEvaluator, double[] pDynamicSymbolValues, double pStartTime, double pEndTime, int pNumResultsTimePoints, Symbol[] pRequestedSymbols, double[] pRetResultsTimeValues, Object[] pRetResultsSymbolValues) throws InvalidInputException, DataNotFoundException, FileNotFoundException, IOException, SimulationFailedException {
        ...
        while (null != (line = inputReader.readLine())) {
            ...
            timeIndex = addRequestedSymbolValues(curTime, timeIndex, pRequestedSymbols, symbolEvaluator, pRetResultsTimeValues, pRetResultsSymbolValues);
        }
    ...
    public double[] f(double t, double[] x) {
        ...
        try {
            computeDerivative(mSpeciesRateFactorEvaluator, mSymbolEvaluator, mReactions, mDynamicSymbolAdjustmentVectors, mReactionProbabilities, mScratch, mDerivative);
    ...
    public double[] g(double t, double[] x) {   // empty implementation of g because there are no events associated
