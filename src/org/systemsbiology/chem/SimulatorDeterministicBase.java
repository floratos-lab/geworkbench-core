...
public abstract class SimulatorDeterministicBase extends Simulator {
    ...
    //AM--5/2 they made this static
    static double langevinAmplification = 0.03;
    ...
    public void setLangevinAmplification(double langevinAmplification) {
        this.langevinAmplification = langevinAmplification;
    }

    public double getLangevinAmplification() {
        return langevinAmplification;
    }

    protected abstract void setupScratchPad(double pStartTime, double pEndTime, SimulatorParameters pSimulatorParams, RKScratchPad pRKScratchPad);

    protected abstract double iterate(SpeciesRateFactorEvaluator pSpeciesRateFactorEvaluator, SymbolEvaluatorChemSimulation pSymbolEvaluator, Reaction[] pReactions, Object[] pDynamicSymbolAdjustmentVectors, double[] pReactionProbabilities, RKScratchPad pRKScratchPad, double[] pDynamicSymbolValues, double[] pNewDynamicSymbolValues) throws DataNotFoundException, SimulationAccuracyException;

    protected static final void rk4step(SpeciesRateFactorEvaluator pSpeciesRateFactorEvaluator, SymbolEvaluatorChemSimulation pSymbolEvaluator, Reaction[] pReactions, Object[] pDynamicSymbolAdjustmentVectors, double[] pReactionProbabilities, RKScratchPad pRKScratchPad, double pTimeStepSize, double[] pDynamicSymbolValues, double[] pNewDynamicSymbolValues) throws DataNotFoundException {
        ...
        computeDerivative(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, yscratch, k1);
        ...
        computeDerivative(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, yscratch, k2);
        ...
        computeDerivative(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, yscratch, k3);
        ...
        computeDerivative(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, yscratch, k4);
        ...
        for (int ctr = numVars; --ctr >= 0;) {
            newDynamicSymbolValue = ysav[ctr] + (k1[ctr] / 3.0) + (2.0 * k2[ctr] / 3.0) + (k3[ctr] / 3.0) + (k4[ctr] / 6.0);
            //AM--4/1  Added the langevin term here
            //pNewDynamicSymbolValues[ctr] = newDynamicSymbolValue;
            try {
                //          double langevin = Math.sqrt(newDynamicSymbolValue) *
                double langevin = Math.sqrt(pTimeStepSize) * langevinAmplification * (Math.random() * 2 - 1);
                pNewDynamicSymbolValues[ctr] = Math.max(0, newDynamicSymbolValue + langevin);
            } catch (Exception e) {
                System.out.println(e.getMessage());
                pNewDynamicSymbolValues[ctr] = 0;
            }
        }
    ...
    protected static final void computeScale(SpeciesRateFactorEvaluator pSpeciesRateFactorEvaluator, SymbolEvaluatorChemSimulation pSymbolEvaluator, Reaction[] pReactions, Object[] pDynamicSymbolAdjustmentVectors, double[] pReactionProbabilities, RKScratchPad pRKScratchPad, double pTimeStepSize, double[] pDynamicSymbolValues, double[] yscale) throws DataNotFoundException, SimulationAccuracyException {
        double[] yscratch = pRKScratchPad.yscratch;
        ...
        computeDerivative(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, yscratch, dydt);
    ...
    protected static final void rkqc(SpeciesRateFactorEvaluator pSpeciesRateFactorEvaluator, SymbolEvaluatorChemSimulation pSymbolEvaluator, Reaction[] pReactions, Object[] pDynamicSymbolAdjustmentVectors, double[] pReactionProbabilities, RKScratchPad pRKScratchPad, double pTimeStepSize, double[] pDynamicSymbolValueScales, double[] pDynamicSymbolValues, double[] pNewDynamicSymbolValues, MutableDouble pRetAggregateRelativeError, MutableDouble pRetAggregateAbsoluteError) throws DataNotFoundException {
        double time = pSymbolEvaluator.getTime();
        int numDynamicSymbols = pDynamicSymbolValues.length;

        rk4step(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, pRKScratchPad, pTimeStepSize, pDynamicSymbolValues, pNewDynamicSymbolValues);
        ...
        rk4step(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, pRKScratchPad, halfStepSize, pDynamicSymbolValues, y1);
        ...
        rk4step(pSpeciesRateFactorEvaluator, pSymbolEvaluator, pReactions, pDynamicSymbolAdjustmentVectors, pReactionProbabilities, pRKScratchPad, halfStepSize, pDynamicSymbolValues, y2);
    ...
    public void simulate(double pStartTime, double pEndTime, SimulatorParameters pSimulatorParameters, int pNumResultsTimePoints, String[] pRequestedSymbolNames, double[] pRetTimeValues, Object[] pRetSymbolValues) throws DataNotFoundException, IllegalStateException, SimulationAccuracyException {
        conductPreSimulationCheck(pStartTime, pEndTime, pSimulatorParameters, pNumResultsTimePoints, pRequestedSymbolNames, pRetTimeValues, pRetSymbolValues);
        ...
        double[] timesArray = createTimesArray(pStartTime, pEndTime, pNumResultsTimePoints);

        Symbol[] requestedSymbols = createRequestedSymbolArray(mSymbolMap, pRequestedSymbolNames);
        ...
        setupScratchPad(pStartTime, pEndTime, pSimulatorParameters, scratchPad);
        ...
        while (pNumResultsTimePoints - timeCtr > 0) {
            time = iterate(speciesRateFactorEvaluator, symbolEvaluator, reactions, dynamicSymbolAdjustmentVectors, reactionProbabilities, scratchPad, dynamicSymbolValues, newSimulationSymbolValues);

            ++(scratchPad.numIterations);

            if (time > timesArray[timeCtr]) {
                //update values
                timeCtr = addRequestedSymbolValues(time, timeCtr, requestedSymbols, symbolEvaluator, timesArray, pRetSymbolValues);
            }
    ...
    public void simulateSteadyState(double pStartTime, double pEndTime, SimulatorParameters pSimulatorParameters, int pNumResultsTimePoints, String[] pRequestedSymbolNames, double[] pRetTimeValues, Object[] pRetSymbolValues) throws DataNotFoundException, IllegalStateException, SimulationAccuracyException {
        conductPreSimulationCheck(pStartTime, pEndTime, pSimulatorParameters, pNumResultsTimePoints, pRequestedSymbolNames, pRetTimeValues, pRetSymbolValues);
        ...
        while (!converged) {
            ...
            if (time > timesArray[timeCtr]) {
                //update values
                timeCtr = addRequestedSymbolValues(time, timeCtr, requestedSymbols, symbolEvaluator, timesArray, pRetSymbolValues);
                //        converged = checkConvergence(pRetSymbolValues);
            }
    ...
    boolean checkConvergence(Object[] simVals, int lastTimeVal) {
        double tolerance;
        int windowSize;
        int numWindows;
