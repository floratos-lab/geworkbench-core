...
public abstract class SimulationService implements ISimulationService {
    ...
    public void doTimeBasedSimulation(Module pSource, double pStartTime, double pEndTime, int pNumPoints, String[] pFilter) throws SBWException {
        ...
        try {
            ...
            simulator.simulate(pStartTime, pEndTime, simulatorParameters, pNumPoints, pFilter, timeValues, symbolValues);
