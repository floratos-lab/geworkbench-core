...
public class Reaction extends SymbolValue {
    ...
    public class ReactionElement implements Comparable {
        ...
        public boolean equals(ReactionElement pReactionElement) {
            return (mSpecies.equals(pReactionElement.mSpecies) && mStoichiometry == pReactionElement.mStoichiometry && mDynamic == pReactionElement.mDynamic);
        }
    ...
    public void constructSpeciesArrays(Species[] pSpeciesArray, // this is the array of species that we are constructing
                                       ...
                                       boolean[] pDynamicArray, Species[] pDynamicSymbolValues, // a vector of all species in the model
                                       SymbolValue[] pNonDynamicSymbolValues, HashMap pSymbolMap, // a map between species names and the index in previous vector
    ...
    void prepareSymbolVectorsForSimulation(Species[] pDynamicSymbolValues, SymbolValue[] pNonDynamicSymbolValues, HashMap pSymbolMap) {
        ...
        constructSpeciesArrays(mReactantsSpeciesArray, mReactantsStoichiometryArray, mReactantsDynamicArray, pDynamicSymbolValues, pNonDynamicSymbolValues, pSymbolMap, ParticipantType.REACTANT);
        ...
        constructSpeciesArrays(mProductsSpeciesArray, mProductsStoichiometryArray, mProductsDynamicArray, pDynamicSymbolValues, pNonDynamicSymbolValues, pSymbolMap, ParticipantType.PRODUCT);
    ...
    private void constructLocalSymbolsVector() {
        ...
        Simulator.indexSymbolArray(localSymbolsArray, localSymbolsMap, null, mLocalSymbolsValues);
    ...
    //AM--3/10 made these methods public
    ...
    public boolean equals(Reaction pReaction) {
        return (mName.equals(pReaction.mName) && mReactantsMap.equals(pReaction.mReactantsMap) && mProductsMap.equals(pReaction.mProductsMap) && super.equals(pReaction));
    }
     ...
     */
    final double computeRate(SpeciesRateFactorEvaluator pSpeciesRateFactorEvaluator, SymbolEvaluatorChemSimulation pSymbolEvaluator) throws DataNotFoundException {
        ...
        if (!mRateIsExpression) {
            ...
            for (int reactantCtr = numReactants; --reactantCtr >= 0;) {
                rate *= pSpeciesRateFactorEvaluator.computeRateFactorForSpecies(pSymbolEvaluator, reactants[reactantCtr], stoichiometries[reactantCtr]);
            }
    ...
    public void addSpecies(Species pSpecies, int pStoichiometry, boolean pDynamic, ParticipantType pParticipantType) throws IllegalArgumentException {
        if (pParticipantType.equals(ParticipantType.REACTANT)) {
