...
public class ParserPicker {
    ...
    private void handleCancel() {
        SimpleDialog messageDialog = new SimpleDialog(mMainFrame, "Model processing cancelled", "Your model processing has been cancelled");
    ...
    public String selectParserAliasFromFileName(String pFileName) {
        ...
        if (null == parserAlias) {
            ...
            JOptionPane parserOptionPane = new JOptionPane(textArea, JOptionPane.WARNING_MESSAGE, JOptionPane.DEFAULT_OPTION, null, parserOptions);
