...
public class ExHelpSearchNavigator extends SearchView {
    public ExHelpSearchNavigator(HelpSet hs, String name, String label, Hashtable params) {
        super(hs, name, label, params);
    }

    public ExHelpSearchNavigator(HelpSet hs, String name, String label, Locale locale, Hashtable params) {
