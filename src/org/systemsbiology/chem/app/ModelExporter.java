...
public class ModelExporter {
    ...
    public void exportModel(Model pModel, ClassRegistry pModelExporterRegistry) {
        ...
        JOptionPane optionPane = new JOptionPane("Which exporter plugin do you wish to use?", JOptionPane.QUESTION_MESSAGE, JOptionPane.DEFAULT_OPTION, null, options);
            ...
            if (null != outputFile) {
                ...
                if (null != exporter) {
                    ...
                    if (!fileNameMatchesRegex) {
                        ...
                        SimpleDialog messageDialog = new SimpleDialog(mMainFrame, "Non-standard export filename specified", textArea);
                    ...
                    if (doExport && outputFile.exists()) {
                        doExport = FileChooser.handleOutputFileAlreadyExists(mMainFrame, fileName);
                    }
