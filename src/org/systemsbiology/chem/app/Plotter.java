...
import org.systemsbiology.util.ImageTransferHandler;
...
public class Plotter {
    ...
    class Plot extends JFrame {
        ...
        public void handleResize() {
            ...
            mPlotScrollPane.setPreferredSize(new Dimension(newPlotWidthPixels + SCROLL_PANE_OFFSET_PIXELS, newPlotHeightPixels + SCROLL_PANE_OFFSET_PIXELS));
                ...
                if (doSave) {
                    ...
                    if (!selectedFileName.matches(".*\\." + OUTPUT_IMAGE_TYPE_EXTENSION + "$")) {
                        if (-1 != selectedFileName.indexOf('.')) {
                            ...
                            SimpleDialog messageDialog = new SimpleDialog(this, "Use non-standard file name?", textArea);
    ...
    public void plot(String pAppName, String pData, String pSimulatorAlias, String pModelName, String pLabel) throws IOException, NumberFormatException {
        ...
        Point location = mFramePlacer.placeInCascadeFormat(frameSize.width, frameSize.height);
