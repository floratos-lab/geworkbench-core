...
public class MainApp {
    ...
    private void loadModel() {
        ...
        if (null != model) {
            ...
            if (result == SimulationLauncher.SetModelResult.FAILED_RUNNING) {
                SimpleDialog dialog = new SimpleDialog(mMainFrame, "unable to reload model", "Sorry, the model cannot be reloaded while a simulation is running.  Please wait for the simulation to complete and then try again.");
                dialog.show();
    ...
    void updateMenus() {
        ...
        enableMenuItem(MainMenu.MenuItem.TOOLS_RELOAD, !bufferEmpty && null != simulationLauncher && timestampLastChange > timestampModelLastLoaded.longValue() && !simulationRunning);
    }
    ...
    private void initializeMainFrame() throws DataNotFoundException {
        ...
        Point frameLocation = FramePlacer.placeInCenterOfScreen(frameWidth, frameHeight);
        ...
        frame.addComponentListener(new ComponentAdapter() {
            public void componentResized(ComponentEvent e) {
                ...
                mEditorPane.handleResize(widthPixels - mOriginalWidthPixels, heightPixels - mOriginalHeightPixels);
    ...
    private static String handleWindowsArgumentMangling(String pAppDir) {
        ...
        if (retString.endsWith("\"")) {
            ...
            if (!retString.endsWith(File.separator) && !retString.endsWith("\\") && !retString.endsWith("/")) {
