...
public class SimulationLauncherCommandLine extends CommandLineApp {
    ...
    private void run(String[] pArgs) {
        try {
            ...
            simulator.simulate(mStartTime.doubleValue(), mStopTime.doubleValue(), mSimulatorParameters, numSamples, globalSymbolsArray, resultsTimeValues, resultsSymbolValues);
            ...
            TimeSeriesSymbolValuesReporter.reportTimeSeriesSymbolValues(mOutputFilePrintWriter, globalSymbolsArray, resultsTimeValues, resultsSymbolValues, mOutputFileFormat);
