...
public class MainMenu extends JMenuBar {
    ...
    private void createMenu() throws DataNotFoundException {
        ...
        MenuItem[] fileItems = new MenuItem[]{MenuItem.FILE_OPEN, MenuItem.FILE_SAVE, MenuItem.FILE_SAVE_AS, MenuItem.FILE_CLOSE, MenuItem.FILE_QUIT};
        int[] fileShortcuts = {'O', 'S', 'A', 'C', 'Q'};

        createSingleMenu(Menu.FILE, fileItems, fileShortcuts);

        MenuItem[] editItems = new MenuItem[]{MenuItem.EDIT_CUT, MenuItem.EDIT_COPY, MenuItem.EDIT_PASTE};
        int[] editShortcuts = {'T', 'C', 'P'};

        createSingleMenu(Menu.EDIT, editItems, editShortcuts);

        MenuItem[] toolsItems = new MenuItem[]{MenuItem.TOOLS_EXPORT, MenuItem.TOOLS_SIMULATE, MenuItem.TOOLS_RELOAD, MenuItem.TOOLS_CYTOSCAPE, MenuItem.TOOLS_HUMAN_READABLE};
        int[] toolsShortcuts = {'E', 'S', 'R', 'C', 'H'};

        createSingleMenu(Menu.TOOLS, toolsItems, toolsShortcuts);

        MenuItem[] helpItems = new MenuItem[]{MenuItem.HELP_ABOUT, MenuItem.HELP_BROWSER};
