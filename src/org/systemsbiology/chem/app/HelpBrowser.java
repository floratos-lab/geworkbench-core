        ...
        try {
            ...
            if (helpSetName != null && helpSetName.trim().length() > 0) {
                ...
                if (null != helpPackageURL) {
                    ...
                    SimpleDialog notFoundDialog = new SimpleDialog(mMainFrame, "Help file not found", "The help file was not found: " + helpSetName);
                    notFoundDialog.show();
                }
            } else {
                SimpleDialog notFoundDialog = new SimpleDialog(mMainFrame, "No help is available", "Sorry, no on-line help is available");
                notFoundDialog.show();
            }
        } catch (Exception e) {
            ExceptionDialogOperationCancelled exceptionDialog = new ExceptionDialogOperationCancelled(mMainFrame, "Error displaying online help", e);
