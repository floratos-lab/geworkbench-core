...
public class ClassRegistry {
    ...
    private void recursivelyRegisterAllClassesUnderPackage(String pPackageName, HashSet pPackagesAlreadySearched, Class pInterface, HashMap pRegistry) throws IOException, IllegalArgumentException {
            ...
            if (directory.exists()) {
                ...
                for (int fileCtr = 0; fileCtr < numFiles; ++fileCtr) {
                    ...
                    if (subFile.isDirectory()) {
                        ...
                        recursivelyRegisterAllClassesUnderPackage(subPackageName, pPackagesAlreadySearched, pInterface, pRegistry);
                    }
    ...
    public void buildRegistry() throws ClassNotFoundException, IOException, IllegalArgumentException {
        ...
        recursivelyRegisterAllClassesUnderPackage("org.systemsbiology", packagesAlreadySearched, getInterface(), getRegistry());
