...
public class Expression implements Cloneable {
    ...
    public List tokenizeExpression(String pFormula) throws IllegalArgumentException {
    ...
    public Element convertTokenToElement(Token pToken) throws IllegalArgumentException {
        TokenCode tokCode = pToken.mCode;
        if (tokCode != TokenCode.EXPRESSION && tokCode != TokenCode.SYMBOL && tokCode != TokenCode.NUMBER) {
