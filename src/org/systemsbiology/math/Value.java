...
public class Value {
    ...
    public Value(Value value) {
        this.mExpressionCacheValue = value.getMExpressionCacheValue();
        this.mExpressionValue = value.getMExpressionValue();
        this.mNumericValue = value.getMNumericValue();
        this.mExpressionValueCached = value.isMExpressionValueCached();
    }
    ...
    public Expression getMExpressionValue() {
        return mExpressionValue;
    }

    public boolean isMExpressionValueCached() {
        return mExpressionValueCached;
    }

    public MutableDouble getMExpressionCacheValue() {
        return mExpressionCacheValue;
    }

    public void setMNumericValue(MutableDouble mNumericValue) {
        this.mNumericValue = mNumericValue;
    }

    public void setMExpressionValue(Expression mExpressionValue) {
        this.mExpressionValue = mExpressionValue;
    }

    public void setMExpressionValueCached(boolean mExpressionValueCached) {
        this.mExpressionValueCached = mExpressionValueCached;
    }

    public void setMExpressionCacheValue(MutableDouble mExpressionCacheValue) {
        this.mExpressionCacheValue = mExpressionCacheValue;
    }

    public MutableDouble getMNumericValue() {
